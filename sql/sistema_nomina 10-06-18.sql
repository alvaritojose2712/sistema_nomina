...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2018 a las 15:48:02
...
CREATE TABLE `formulas` (
  `id` int(5) NOT NULL,
  `condiciones` mediumtext CHARACTER SET latin1 NOT NULL,
  `operaciones` mediumtext CHARACTER SET latin1 NOT NULL,
...
(23, '{"estado":{"ACTIVO":"igual","JUBILADO":"igual","PENSIONADO":"igual"},"categoria":{"OBRERO":"igual"},"cargo":{"4":"igual"}}', '{"operacion":"((($sueldo_normal/30)/8)*0.3)*$hrs_nocturnas"}', 'bono salarial', 'sueldo normal', 'asignacion', 'mensual', 'Bono nocturno - OBRERO', '2017-09-01'),
...
(15, 'Junior', 'Peña', '2017-11-30', 25657161, 0, 'no', 'no');
...
CREATE TABLE `instituciones` (
  ...
  `organo_adscripcion` varchar(80) NOT NULL,
  `codigo_presupuestario` varchar(10) NOT NULL,
  `codigo_institucion` varchar(5) NOT NULL,
  `cuenta_matriz` varchar(25) NOT NULL
...
INSERT INTO `instituciones` (`id`, `denominacion`, `organo_adscripcion`, `codigo_presupuestario`, `codigo_institucion`, `cuenta_matriz`) VALUES
(2, 'UPTAAPCC', 'Ministerio del Poder Popular para Educación Universitaria Ciencia, Tecnología', 'A 1364', '0623', '01750090260070194767');
...
(132, 'alvaritojose2712', 'david22', 'Hola como estas?', '2018-04-16 19:57:45'),
(133, 'alvaritojose2712', 'LeoMessi10', 'Epale chamo!!! :v', '2018-04-16 19:58:11'),
(134, 'alvaritojose2712', 'LeoMessi10', 'Hola cmo estas', '2018-04-17 14:37:58'),
(135, 'alvaritojose2712', 'LeoMessi10', 'Hola mundo', '2018-06-06 03:32:24'),
(136, 'alvaritojose2712', 'LeoMessi10', 'Jajajaj', '2018-06-06 03:34:04'),
(137, 'alvaritojose2712', 'LeoMessi10', 'Epa caballo', '2018-06-06 03:36:12'),
(138, 'alvaritojose2712', 'LeoMessi10', 'jajasjands', '2018-06-06 03:36:19');
...
CREATE TABLE `parametros_nomina` (
  `id` int(5) NOT NULL,
  `denominacion` mediumtext CHARACTER SET latin1 NOT NULL,
  `tipo_periodo` varchar(50) CHARACTER SET latin1 NOT NULL,
  `formulas_a_pagar` mediumtext CHARACTER SET latin1 NOT NULL,
  `divisiones` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `engine` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
  `incl_excl` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `opera_espec` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `filtros` mediumtext COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `parametros_nomina` (`id`, `denominacion`, `tipo_periodo`, `formulas_a_pagar`, `divisiones`, `fecha`, `engine`, `incl_excl`, `opera_espec`, `filtros`) VALUES
(2, 'Sueldo Básico ', 'mensual', '{"1":"","6":"","15":"","21":"","24":"","49":""}', '{"1era quincena":{"1":"100","6":"100","15":"100","21":"100","24":"100","49":"100"},"2da quincena":{"1":"0","6":"0","15":"0","21":"0","24":"0","49":"0"}}', '2018-06-09 22:51:58', 'convencional', '{}', '{}', '{"genero":{"Masculino":""}}'),
(3, 'Aporte patronal', 'mensual', '{"50":"","51":""}', '{"Mes_de_enero":{"50":"100","51":"100"}}', '2018-06-08 21:45:26', 'aporte patronal', '', '', '{}'),
(7, 'Nómina de Bono Vacacional Masculinos Administrativos', 'anual', '{"45":""}', '{"Pago_Normal":{"45":"100"}}', '2018-06-08 23:50:05', 'convencional', '{}', '{}', '{}');
...
(2, 'ACTIVO', 'Silfredo', 'Rivero', 9868006, 'V', 'Masculino', '1967-10-18', '202022', '987665', 'josesilfre2012@gmail.com', 'EMPLEADO FIJO', '2002-02-13', 'MASTER', 'DOCENTE', 'EXCLUSIVA', 'si', 'ASOCIADO', '0175009083647', 0, 0, 0, 0, 0, 'Ing. Mecánico', 'Presupuesto', 'Contador'),
...
(6, 'JUBILADO', 'Jose', 'Peña', 25657161, 'V', 'Masculino', '1981-11-30', '24323232323', '232323232', '@peña', 'CONTRATADO', '2017-11-29', 'TSU', 'DOCENTE', 'EXCLUSIVA', 'no', 'AGREGADO', '343434343', 0, 0, 0, 0, 0, 'Ing. Agrónomo', 'PNF Agroalimentación', 'Maestro'),
...
CREATE TABLE `prestaciones_sociales` (
  `id` int(4) NOT NULL,
  `DIAS_TRABAJADOS_literal_b` int(4) NOT NULL,
  `DIAS_DE_PRESTACIONES_literal_b` int(4) NOT NULL,
  `MAX_DIAS_ADICIONALES_literal_b` int(4) NOT NULL,
  `DIAS_ADICIONALES_literal_b` int(4) NOT NULL,
  `DIAS_x_AÑO_literal_c` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `prestaciones_sociales` (`id`, `DIAS_TRABAJADOS_literal_b`, `DIAS_DE_PRESTACIONES_literal_b`, `MAX_DIAS_ADICIONALES_literal_b`, `DIAS_ADICIONALES_literal_b`, `DIAS_x_AÑO_literal_c`) VALUES
(1, 90, 15, 30, 2, 30);
...
CREATE TABLE `valores_globales` (
  `id` int(11) NOT NULL,
  `cat_car_dedic` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `grado_instruccion` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `estado` mediumtext COLLATE utf8_spanish_ci NOT NULL,
  `estatus` mediumtext COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
