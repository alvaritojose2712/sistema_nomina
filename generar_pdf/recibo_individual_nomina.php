...
if (isset($_POST['reporte_general_pdf_data'])) {
	$mpdf->WriteHTML(str_replace("image/cintillo.jpg", "../image/cintillo.jpg", $_POST['reporte_general_pdf_data']));
}elseif (isset($_POST['g-recibo-data'])) {
