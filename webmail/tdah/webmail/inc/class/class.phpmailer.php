...
class PHPMailer {
  ...
  function SmtpSend($header, $body) {
    include_once($this->PluginDir . "inc/class/class.smtp.php");
    $error = '';
    $bad_rcpt = array();
   ...
   * @return bool
   */
  function SetLanguage($lang_type, $lang_path = 'langs/') {
  ...
  function CreateHeader() {
    ...
    $result .= $this->HeaderLine('X-Mailer', 'T-dah Webmail [version ' . $this->Version . ']');
